...
jest.mock("@chakra-ui/react", () => {
    ...
    return {
        ...
        Image: ({ children, ...props }) => (
            <Image {...props} role="test-image" className={"test-image " + props.className}>
                {children}
            </Image>
        ),
    };
...
describe("path /", () => {
    ...
    it("shows Loading component", async () => {
        ...
        await waitFor(async () => expect(await screen.findByText("Loading...")).toBeTruthy());
    });
    ...
    describe("Container UI", () => {
        it("should use SimpleGrid with `Cards` component as children", async () => {
            ...
            expect(container.querySelector(".test-simple-grid .test-box.yugioh-card")).toBeTruthy();
        });
    });
    describe("Cards UI", () => {
        it("card titles should be rendered with Chakra UI Heading, as `h2`", async () => {
            ...
            const yugiohCards = container.querySelectorAll(".yugioh-card h2.test-heading");

            const cardTitles = Array.from(yugiohCards).map((card) => card.textContent);
        ...
        it("card images should be rendered with Chakra UI Image", async () => {
            ...
            const yugiohCards = container.querySelectorAll(".yugioh-card .test-image");

            const cardImages = Array.from(yugiohCards).map((card) => card.src);

            expect(cardImages).toEqual(mockedData.data.map((card) => card.card_images[0].image_url));
        });
        ...
        it("card component (Box) should be wrapped with a link to the card details page", async () => {
            ...
            expect(cardLinks).toEqual(mockedData.data.map((card) => `http://localhost/card/${card.id}`));
        });
    });
    ...
    describe("sorting behavior", () => {
        describe("when sorted by attack", () => {
            it("should sort correctly", async () => {
                ...
                userEvent.selectOptions(container.querySelector("[name=sort]"), "Attack");

                const yugiohCard = container.getElementsByClassName("yugioh-card");

                const cardTitles = Array.from(yugiohCard).map((card) => card.querySelector("h2").textContent);

                await waitFor(() => expect(cardTitles).toEqual(mockedData.data.sort((a, b) => a.atk - b.atk).map((card) => card.name)));
            });
        });
        ...
        describe("when sorted by name", () => {
            it("should sort correctly", async () => {
                ...
                await waitFor(() => expect(cardTitles).toEqual(mockedData.data.sort((a, b) => a.name.localeCompare(b.name)).map((card) => card.name)));
            });
        });
        ...
        describe("when sorted by defence", () => {
            it("should sort correctly", async () => {
                ...
                userEvent.selectOptions(container.querySelector("[name=sort]"), "Defence");

                const yugiohCard = container.getElementsByClassName("yugioh-card");

                const cardTitles = Array.from(yugiohCard).map((card) => card.querySelector("h2").textContent);

                await waitFor(() => expect(cardTitles).toEqual(mockedData.data.sort((a, b) => a.def - b.def).map((card) => card.name)));
            });
        });
    });
});
...
describe("path /card/:id", () => {
    ...
    describe("should render card correctly", () => {
        it("Should show data correctly", async () => {
            ...
            await waitFor(async () => expect(await screen.findByText(singleMockedData.data[0].name)).toBeTruthy());
            expect(screen.getByText(`Level: ${data.level}`).classList.contains("test-text")).toBeTruthy();
            expect(screen.getByText(`${data.attribute}`).classList.contains("test-text")).toBeTruthy();
            expect(screen.getByText(`ATK/${data.atk} DEF/${data.def}`).classList.contains("test-text")).toBeTruthy();
            expect(screen.getByText(`[ ${data.type} / ${data.race} ]`).classList.contains("test-text")).toBeTruthy();
            screen.getByRole("test-image");
            expect(container.querySelector(`.test-image[src='${data.card_images[0].image_url}']`)).toBeTruthy();
            ...
            card_images: [
                {
                    ...
                    image_url_small: "https://images.ygoprodeck.com/images/cards_small/61901281.jpg",
                },
            ],
            card_prices: [
                {
            ...
            card_images: [
                {
                    ...
                    image_url_small: "https://images.ygoprodeck.com/images/cards_small/581014.jpg",
                },
            ],
            card_prices: [
                {
            ...
            card_images: [
                {
                    ...
                    image_url_small: "https://images.ygoprodeck.com/images/cards_small/14536035.jpg",
                },
            ],
            card_prices: [
                {
            ...
            card_images: [
                {
                    ...
                    image_url_small: "https://images.ygoprodeck.com/images/cards_small/51858306.jpg",
                },
            ],
            card_prices: [
                {
            ...
            card_images: [
                {
                    ...
                    image_url_small: "https://images.ygoprodeck.com/images/cards_small/17412721.jpg",
                },
            ],
            card_prices: [
                {
            ...
            card_images: [
                {
                    ...
                    image_url_small: "https://images.ygoprodeck.com/images/cards_small/55623480.jpg",
                },
            ],
            card_prices: [
                {
            ...
            card_images: [
                {
                    ...
                    image_url_small: "https://images.ygoprodeck.com/images/cards_small/99177923.jpg",
                },
            ],
            card_prices: [
                {
            ...
            card_images: [
                {
                    ...
                    image_url_small: "https://images.ygoprodeck.com/images/cards_small/34086406.jpg",
                },
            ],
            card_prices: [
                {
            ...
            card_images: [
                {
                    ...
                    image_url_small: "https://images.ygoprodeck.com/images/cards_small/38572779.jpg",
                },
            ],
            card_prices: [
                {
            ...
            card_images: [
                {
                    ...
                    image_url_small: "https://images.ygoprodeck.com/images/cards_small/54719828.jpg",
                },
            ],
            card_prices: [
                {
            ...
            card_images: [
                {
                    ...
                    image_url_small: "https://images.ygoprodeck.com/images/cards_small/63504681.jpg",
                },
            ],
            card_prices: [
                {
            ...
            card_images: [
                {
                    ...
                    image_url_small: "https://images.ygoprodeck.com/images/cards_small/57835716.jpg",
                },
            ],
            card_prices: [
                {
            ...
            card_images: [
                {
                    ...
                    image_url_small: "https://images.ygoprodeck.com/images/cards_small/7563579.jpg",
                },
            ],
            card_prices: [
                {
            ...
            card_images: [
                {
                    ...
                    image_url_small: "https://images.ygoprodeck.com/images/cards_small/12958919.jpg",
                },
            ],
            card_prices: [
                {
            ...
            card_images: [
                {
                    ...
                    image_url_small: "https://images.ygoprodeck.com/images/cards_small/18326736.jpg",
                },
            ],
            card_prices: [
                {
            ...
            card_images: [
                {
                    ...
                    image_url_small: "https://images.ygoprodeck.com/images/cards_small/99234526.jpg",
                },
            ],
            card_prices: [
                {
            ...
            card_images: [
                {
                    ...
                    image_url_small: "https://images.ygoprodeck.com/images/cards_small/85115440.jpg",
                },
            ],
            card_prices: [
                {
            ...
            card_images: [
                {
                    ...
                    image_url_small: "https://images.ygoprodeck.com/images/cards_small/48905153.jpg",
                },
            ],
            card_prices: [
                {
